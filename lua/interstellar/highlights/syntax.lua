-- local c = require("interstellar.color")
local M = {}
...
function M.setup(colors, config)
  ...
  config = config or require("interstellar").config

  return {
    -- *Comment	any comment
    Comment = vim.tbl_extend("force", { fg = theme.syn.comment }, config.style.comments),
    ...
    Function = vim.tbl_extend("force", { fg = theme.syn.fun }, config.style.functions),

    -- *Statement	any statement
    Statement = vim.tbl_extend("force", { fg = theme.syn.statement }, config.style.statements),
    ...
    Keyword = vim.tbl_extend("force", { fg = theme.syn.keyword }, config.style.keywords),
    ...
    Type = vim.tbl_extend("force", { fg = theme.syn.type }, config.style.types),
