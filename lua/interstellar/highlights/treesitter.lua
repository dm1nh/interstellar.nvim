...
function M.setup(colors, config)
  ...
  return {
    ...
    ["@keyword.return"] = vim.tbl_extend("force", { fg = theme.syn.special3 }, config.style.keywords),
    -- @keyword.debug          keywords related to debugging
    -- @keyword.exception      keywords related to exceptions (e.g. `throw`, `catch`)
    ["@keyword.exception"] = vim.tbl_extend("force", { fg = theme.syn.special3 }, config.style.statements),
    ...
    -- @conceal                JSON "" characters
    ["@conceal"] = { link = "Conceal" },

    -- gdscript
    ["@string.special.url.gdscript"] = { link = "PreProc" },
  }
end
