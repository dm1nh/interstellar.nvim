...
function M.setup(colors, config)
  ...
  return {
    ...
    CurSearch = { fg = theme.ui.bg, bg = theme.ui.bg_search_current, bold = true },
    -- Cursor		Character under the cursor.
    Cursor = { fg = theme.ui.bg, bg = theme.ui.fg },
    -- lCursor		Character under the cursor when |language-mapping| is used (see 'guicursor').
    lCursor = { link = "Cursor" },
    -- iCursor  Character under the cursor in insert mode
    iCursor = { fg = theme.ui.bg, bg = theme.syn.fun },
    -- rCursor  Character under the cursor in replace mode
    rCursor = { fg = theme.ui.bg, bg = theme.syn.keyword },
